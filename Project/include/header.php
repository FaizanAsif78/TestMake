...
<head>
    ...
    <link rel="icon" href="assets/img/fa.png" type="image/x-icon">
    <title>Ajax Php Website</title>
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="assets/img/Simple Education.png" class="user-img-radious-style"> <span
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="index.php" class="dropdown-item has-icon text-danger"> <i
