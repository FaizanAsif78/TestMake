        ...
        <div class="section-body">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-6">
                    <a href="viewshortques.php"><button type="btn" class="btn btn-primary mb-5" style="margin-left:75%;">
                            View Short Question</button></a>
                    <div class="card ">
                        <form id="mymcqs">
                            <div class="card-header">
                                <h4>Short Questuion</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Class</label>
                                    <select name="class_s_id" id="category" class="form-control">
                                ...
                                <div class="form-group">
                                    <label>Book</label>
                                    <select name="book_s_id" id="Books" class="form-control">
                                ...
                                <div class="form-group">
                                    <label>Chapter</label>
                                    <select name="chp_s_id" id="Chapter" class="form-control">
                                ...
                                <div class="form-group mb-0">
                                    <label>Short Question English</label>
                                    <input class="form-control" id="code" name="short_ques_eng" required="">
                                ...
                                <div class="form-group mb-0">
                                    <label>Short Question Urdu</label>
                                    <input class="form-control" id="proname" name="short_ques_urdu" required="">
...
<script>
    ...
    $(document).ready(function() {
        $("#btn").on("click", function(e) {
            ...
            $.ajax({
                url: "./files/short_ques_insert.php",
                method: "POST",
                data: mydata,
                contentType: false,
                processData: false,
                success: function(res) {
                   ...
                   if (res == 1) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: 'Short Question Has Been Inserted successfully'
                        })
                        // alert('Product HAS BEEN INSERTED');
                        $('#mymcqs').trigger('reset');
                    } else{
                        alert('Short Question HAS BEEN NOT INSERTED');
                    }
                }
            });
        });
